...
@property (nonatomic, assign) iCarouselType type;       //样式
@property (nonatomic, assign) CGFloat perspective;      //透视
@property (nonatomic, assign) CGFloat decelerationRate;  //减速率
@property (nonatomic, assign) CGFloat scrollSpeed;          //滚动速度
@property (nonatomic, assign) CGFloat bounceDistance;       //弹跳距离
@property (nonatomic, assign, getter = isScrollEnabled) BOOL scrollEnabled;     //是否可滚动
@property (nonatomic, assign, getter = isPagingEnabled) BOOL pagingEnabled;
@property (nonatomic, assign, getter = isVertical) BOOL vertical;       //水平还是垂直
@property (nonatomic, readonly, getter = isWrapEnabled) BOOL wrapEnabled;//是否启动旋转木马效果／外部无法直接设置，默认为NO
...
@property (nonatomic, assign) BOOL centerItemWhenSelected;      //设置被选中的单元格在否在中心显示 默认为YES
