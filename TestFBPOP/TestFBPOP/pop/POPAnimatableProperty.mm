...
NSString * const kPOPLayerCornerRadius = @"cornerRadius";       //cornerRadius
NSString * const kPOPLayerBorderWidth = @"borderWidth";         //边框宽度
NSString * const kPOPLayerBorderColor = @"borderColor";         //边框颜色
...
NSString * const kPOPLayerScaleX = @"scaleX";           //缩放 X
NSString * const kPOPLayerScaleXY = @"scaleXY";         //缩放Y
NSString * const kPOPLayerScaleY = @"scaleY";           //缩放XY
