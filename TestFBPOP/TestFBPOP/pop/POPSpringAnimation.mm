...
- (instancetype)copyWithZone:(NSZone *)zone {
  ...
  if (copy) {
    ...
    copy.springBounciness = self.springBounciness;      //弹簧的弹力
    copy.springSpeed = self.springSpeed;                //速度
    copy.dynamicsTension = self.dynamicsTension;        //动力学张力
    copy.dynamicsFriction = self.dynamicsFriction;      //动力摩擦
    copy.dynamicsMass = self.dynamicsMass;              //动力学质量
  }
